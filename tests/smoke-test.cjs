...
assert.match(main, /generateKnowledgeItems\(\{ mode: "heuristic", projectPath \}\)/, "Project scan must automatically generate project-scoped heuristic knowledge items");
...
assert.match(skill, /\.codex-knowledge\/project-knowledge\.md/, "Skill must keep compatibility project knowledge");
